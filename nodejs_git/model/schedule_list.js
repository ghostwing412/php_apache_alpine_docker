 ...
 * @param job
 */
scheduleList.prototype.start = function (job) {
    var _this = this;
    this.job = job;
    redisC.getName(this.key, function () {
        if (this.data) {
            _this.list = this.data;
        }
        // _this.list = this.data;
        job.emit('start');
        _this.save();
 ...
 * @param value
 */
scheduleList.prototype.add = function (name, value) {
 ...
 * @param name
 */
scheduleList.prototype.remove = function (name) {
 ...
 * @returns {*}
 */
scheduleList.prototype.get = function (name) {
 ...
 * 保存入redis
 */
scheduleList.prototype.save = function () {
    redisC.setName(this.key, JSON.stringify(this.list), function () {
